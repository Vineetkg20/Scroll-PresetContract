Here’s the updated code with the token name changed to **VOSC**:
...
contract VOSC {
    string public name = "VineetonScroll";
    string public symbol = "VOSC";
...
This code now reflects the **VOSC** token, keeping all other functionalities the same.
